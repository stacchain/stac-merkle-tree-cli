...
@click.option('--quiet', '-q', is_flag=True, help='Enable quiet mode. Only warnings and errors will be shown.')
@click.pass_context
...
def compute(ctx, catalog_path: str, merkle_tree_file: str):
    ...
    if not merkle_tree:
        logger.error("Merkle tree is empty. Check your Catalog structure and hash methods.")
